...
CREATE TABLE `t_r_account_resources` (
  ...
  `valid_period` datetime DEFAULT NULL COMMENT '有效期至',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='这是一张冗余的关系表。主要是用来便于权限查询';

/*Data for the table `t_r_account_resources` */

insert  into `t_r_account_resources`(`id`,`account_number`,`phone_number`,`resource_id`,`status`,`create_time`,`create_by`,`update_time`,`changed_by`,`version_number`,`is_delete`,`remark`,`valid_period`) values (1,'969391','17330937086',1,'1','2020-12-23 14:22:48',1,'2020-12-23 14:23:06',1,0,0,NULL,NULL),(2,'969392','17330937087',1,'1','2021-04-06 20:11:44',1,'2021-04-06 20:12:33',1,0,0,NULL,NULL);
...
/*Table structure for table `table_business_account_balance_change_log` */

DROP TABLE IF EXISTS `table_business_account_balance_change_log`;

CREATE TABLE `table_business_account_balance_change_log` (
  ...
  `sum` decimal(12,2) DEFAULT NULL COMMENT '转入转出金额',
  ...
  `is_delete` int DEFAULT NULL COMMENT '删除标识',
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='对于平台内部充值账户的余额转入转出记录,  交易费用记录  以月份作为分区标识\n账户余额变动记录表';

/*Data for the table `table_business_account_balance_change_log` */

/*Table structure for table `table_business_account_payment_log` */

DROP TABLE IF EXISTS `table_business_account_payment_log`;

CREATE TABLE `table_business_account_payment_log` (
  `log_id` bigint NOT NULL COMMENT '主键',
  `trade_id` bigint DEFAULT NULL COMMENT '交易流水号',
  `customer_id` bigint DEFAULT NULL COMMENT '客户标识',
  `account_id` bigint DEFAULT NULL COMMENT '账户标识',
  `target_account_id` bigint DEFAULT NULL COMMENT '支付目标账户标识',
  `free_item_id` bigint DEFAULT NULL COMMENT '费用id',
  `free` decimal(10,0) DEFAULT NULL COMMENT '支付金额·',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  `is_delete` int DEFAULT NULL COMMENT '删除标识',
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='账户支付记录表 当发生交易时，会产生支付 这张表用于记录客户的支付信息 对账用';

/*Data for the table `table_business_account_payment_log` */

/*Table structure for table `table_business_account_receivable` */

DROP TABLE IF EXISTS `table_business_account_receivable`;

CREATE TABLE `table_business_account_receivable` (
  `log_id` bigint NOT NULL COMMENT '标识',
  `trade_id` bigint DEFAULT NULL COMMENT '交易流水号',
  `account_id` bigint DEFAULT NULL COMMENT '账户标识',
  `customer_id` bigint DEFAULT NULL COMMENT '收款者标识',
  `source_account_id` bigint DEFAULT NULL COMMENT '源账户id',
  `free` decimal(12,2) DEFAULT NULL COMMENT '收款金额',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  `is_delete` int DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='账户收款记录表';

/*Data for the table `table_business_account_receivable` */

/*Table structure for table `table_business_bankcard_info` */

DROP TABLE IF EXISTS `table_business_bankcard_info`;

CREATE TABLE `table_business_bankcard_info` (
  `id` bigint NOT NULL COMMENT '标识',
  `customer_id` bigint DEFAULT NULL COMMENT '客户标识',
  `bank` varchar(4) DEFAULT NULL COMMENT '银行 详细见数据字典',
  `card_number` bigint DEFAULT NULL COMMENT '银行卡号',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  `is_delete` int DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='记录客户（房东、房客）绑定的银行卡信息';

/*Data for the table `table_business_bankcard_info` */

/*Table structure for table `table_business_banner` */

DROP TABLE IF EXISTS `table_business_banner`;

CREATE TABLE `table_business_banner` (
  `id` bigint NOT NULL COMMENT '主键',
  `image_url` varchar(512) DEFAULT NULL COMMENT '图片路径',
  `title` varchar(32) DEFAULT NULL COMMENT '标题',
  `banner_status` varchar(4) DEFAULT NULL COMMENT '状态',
  `target_url` varchar(512) DEFAULT NULL COMMENT '营销活动的url',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  `version_number` int DEFAULT '0' COMMENT '字段版本',
  `is_delete` int DEFAULT '0' COMMENT '删除标识',
  `sort` int DEFAULT NULL COMMENT '优先级',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='轮播图信息表';

/*Data for the table `table_business_banner` */

insert  into `table_business_banner`(`id`,`image_url`,`title`,`banner_status`,`target_url`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`,`sort`) values (1383059651132293122,'http://localhost:9000/yeju/1fb049af-16ae-437b-8b3c-fd6682c9fe24致一.jpg','shouge','1','http://localhost/advertise/banner','2021-04-16 22:08:11',969391,NULL,NULL,NULL,0,0,99),(1383065741106511874,'http://localhost:9000/yeju/ae789212-5b81-40c7-b52d-2bfdab17451f8517583.jpg','fofhdsahdu','1','http://tools.jb51.net/regex/create_reg','2021-04-16 22:32:23',969391,NULL,NULL,NULL,0,0,9),(1383070758756581378,'http://localhost:9000/yeju/e9e498e0-0a25-473b-a961-15a20fa7314f8517805.jpg','hasjHXSJAXA','1','http://127.0.0.1/advertise/banner','2021-04-16 22:52:20',969391,NULL,NULL,NULL,0,0,89),(1383071456139313153,'http://localhost:9000/yeju/ae789212-5b81-40c7-b52d-2bfdab17451f8517583.jpg','SSSSS','1','http://127.0.0.1/advertise/banner','2021-04-16 22:55:06',969391,NULL,NULL,'SSSS',0,0,7);
...
insert  into `table_business_house_images_and_video`(`resource_id`,`house_id`,`file_name`,`file_url`,`resource_status`,`resource_type`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`) values (1,1,'1','http://localhost:9000/yeju/house/big/1.jpg',1,0,NULL,NULL,NULL,NULL,NULL,0,0),(2,1,'2','http://localhost:9000/yeju/house/big/2.jpg',1,0,NULL,NULL,NULL,NULL,NULL,0,0);
...
CREATE TABLE `table_business_house_info` (
  ...
  `rent_unit` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '租金单位/按月 按季 按年',
...
insert  into `table_business_house_info`(`house_id`,`owner_id`,`title`,`community_id`,`building_number`,`building_uint`,`building_floor_number`,`rent`,`rent_unit`,`rental_mode`,`payment_method`,`house_type`,`covered_area`,`use_area`,`floors`,`house_orientation`,`house_decoration_type`,`house_facilities`,`descs`,`house_status`,`house_images_address`,`create_time`,`create_by`,`update_time`,`changed_by`,`version_number`,`is_delete`,`month_added`,`month_completed`) values (1,NULL,'海南大学10栋学生公寓楼出租啦',NULL,NULL,NULL,NULL,'1200.00','2','0','1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'海南大学（Hainan University），简称海大，坐落于海南省海口市，是教育部与海南省人民政府“部省合建高校”、海南省人民政府与财政部共建高校，是海南省属综合性重点大学、海南省“国内一流大学建设”重点支持高校，入选世界一流学科建设高校、“211工程”、“卓越工程师教育培养计划”、“卓越法律人才教育培养计划”、“卓越农林人才教育培养计划”、“中西部高校基础能力建设工程”、“中西部高校综合实力提升工程”、国家建设高水平大学公派研究生项目、中国政府奖学金来华留学生接收院校、教育部来华留学示范基地、国家大学生文化素质教育基地、国家级大学生创新创业训练计划，为中西部“一省一校”国家重点建设大学（Z14）联盟、CDIO工程教育联盟成员单位。学校由天津大学对口合作建设。 [1] ','0',NULL,'2021-03-17 17:26:12',NULL,NULL,NULL,0,0,NULL,NULL);
...
CREATE TABLE `table_business_house_info_tradable` (
  ...
  `month_added` int DEFAULT NULL COMMENT '房源信息添加时的月份',
  `month_completed` int DEFAULT NULL COMMENT '房源交易完成时的月份。历史表的分区依据',
  `rent_unit` varchar(4) DEFAULT NULL COMMENT '租金单位/按月 按季 按年',
  PRIMARY KEY (`house_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='房源信息表，其中按照添加时的月份进行表分区。并且仅保留待审核状态的记录。待交易（审核已完成）的记录搬table_busi';
...
CREATE TABLE `table_business_payment` (
  ...
  `advance_payment` bigint DEFAULT NULL COMMENT '域支付id  对应第三方支付的预支付id',
  ...
  `free` decimal(12,2) DEFAULT NULL COMMENT '支付金额',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  KEY `advance_payment` (`advance_payment`),
  KEY `third_party_serial_number` (`third_party_serial_number`)
...
/*Table structure for table `table_business_payment_advance` */

DROP TABLE IF EXISTS `table_business_payment_advance`;

CREATE TABLE `table_business_payment_advance` (
  `withholding_id` bigint DEFAULT NULL COMMENT '主键',
  `transfer_out_account_id` bigint DEFAULT NULL COMMENT '转出账户id',
  `ransfer_to_account_id` bigint DEFAULT NULL COMMENT '目标账户id',
  `payment_id` bigint NOT NULL COMMENT '支付流水号',
  `free` decimal(12,2) DEFAULT NULL COMMENT '最终应扣除金额',
...
/*Data for the table `table_business_payment_advance` */
...
/*Table structure for table `table_business_sms_template` */

DROP TABLE IF EXISTS `table_business_sms_template`;

CREATE TABLE `table_business_sms_template` (
  `id` bigint NOT NULL COMMENT '主键',
  `template` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '模板内容',
  `type` varchar(4) DEFAULT NULL COMMENT '模板类型1有参2无参',
  `status` varchar(4) DEFAULT NULL COMMENT '模板状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `changed_by` bigint DEFAULT NULL COMMENT '更改者',
  ...
  `is_delete` int DEFAULT '0' COMMENT '删除标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='营销短信模板';

/*Data for the table `table_business_sms_template` */

insert  into `table_business_sms_template`(`id`,`template`,`type`,`status`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`) values (1383339252656312321,'【椰居】您的验证码为${auth_code} ${indate}分钟内有效。如果不是您本人操作，请忽略这条短信','1','1','2021-04-17 16:39:14',969391,NULL,NULL,'短信验证码模板',0,0);
...
/*Table structure for table `table_data_community` */

DROP TABLE IF EXISTS `table_data_community`;

CREATE TABLE `table_data_community` (
  `community_id` bigint NOT NULL COMMENT '主键',
  `name` varchar(64) DEFAULT NULL COMMENT '名称',
  `area_id` bigint DEFAULT NULL COMMENT '所在区（县）',
...
/*Data for the table `table_data_community` */

insert  into `table_data_community`(`community_id`,`name`,`area_id`,`city_id`,`province_id`,`detailed_address`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`) values (1384757130706276354,'海南大学海甸校区',1384071987641339906,120,9,'海南省海口市美兰区人民大道58号','2021-04-21 14:33:22',969391,NULL,NULL,'校区',NULL,0);

/*Table structure for table `table_data_district` */

DROP TABLE IF EXISTS `table_data_district`;

CREATE TABLE `table_data_district` (
...
insert  into `table_platform_employees`(`employees_id`,`name`,`gender`,`phone_number`,`employees_number`,`phone_number_prefix`,`leader_id`,`avatar`,`email`,`employee_status`,`create_time`,`create_by`,`update_time`,`changed_by`,`version_number`,`is_delete`,`month_added`,`month_outmoded`,`department_id`) values (1,'超级员工',1,'17330937086',969391,'86',1,'http://localhost:9000/yeju/8469f77f-b29d-43cb-b90c-b5acab2a4bba56eb70e8c716a.jpg','bingfengdev@aliyun.com',1,'2021-02-14 15:29:25',NULL,NULL,NULL,NULL,0,12,NULL,1);
...
insert  into `table_system_resource_md5`(`id`,`resource`,`resource_type`,`md5`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`) values (1,'http://localhost:9000/yeju/img/3.jpg',1,'101',NULL,NULL,NULL,NULL,NULL,1,0),(1357213972349526018,'http://localhost:9000/yeju/f8163e33-a662-4ddc-a8ec-74c0d64507551.png',1,'39e8edf4eba284afe1cb47add95e8543',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1357218276724670466,'http://localhost:9000/yeju/c2798f51-a07c-4efd-a504-4c8e4a4751f456eb70edc6dd1.jpg',1,'af724a3109d1fda82e001159fff39b04',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1357218950820593665,'http://localhost:9000/yeju/1fb049af-16ae-437b-8b3c-fd6682c9fe24致一.jpg',1,'5afefce8c948de630e939be476fb5333',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1357222697806311426,'http://localhost:9000/yeju/8469f77f-b29d-43cb-b90c-b5acab2a4bba56eb70e8c716a.jpg',1,'15e03fee9d1935f31e7953f0b2121f9f',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382980295332679681,'http://localhost:9000/yeju/811aa7b2-42a9-444d-b1ab-725aba92fe61blob',1,'d707cea35749f713c69e87df3fcbf42a',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382980836536307713,'http://localhost:9000/yeju/e9a03b2d-33f2-4886-8834-68e9d1092a1b8510683.jpg',1,'91473afe610e1025a07044e9280dd697',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382981511374655490,'http://localhost:9000/yeju/9be4f6e2-5d69-4969-a9df-7ebdaf228d1cliuyf.zip',1,'812c8e75f0aecabfaa5fcf8455e31047',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382984606825533442,'http://localhost:9000/yeju/95323f54-87a1-4fd3-81d9-b7619188abe3blob',1,'283e9add945c1b89792c584e3c3ae85a',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382984777407877121,'http://localhost:9000/yeju/aa562d22-0ee6-42b1-b209-1a9ddffa0be3blob',1,'8b4b061e65569285979640e3cc59bc22',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382985218640269314,'http://localhost:9000/yeju/f6fbe3c9-fb50-4a96-9e46-2d3c61c51b26blob',1,'bbbc664545862e14ecc106c9b026ca99',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382986094033457154,'http://localhost:9000/yeju/cf7529cf-6f6c-4d7d-a5d1-e7e646828e88blob',1,'554818c59527de715e4c9fb593c11837',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382988407489908737,'http://localhost:9000/yeju/650d1c48-5efd-4c9d-b0af-5392f8f5314dblob',1,'465970aecc801931d64bac69584dfed4',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382989000388333569,'http://localhost:9000/yeju/bac9daad-8172-416a-b481-31d4f24ea217blob',1,'b0204b0be8037a0e0899bf84a459aae7',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382989343817945090,'http://localhost:9000/yeju/86a5c1c7-305b-4916-85ae-ab17ee59f57ablob',1,'53cb4b1be137eed4073c668476d39c5c',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1382996870207066114,'http://localhost:9000/yeju/34a1e3a9-d60d-41ea-8bdc-a60994127499blob',1,'b55083d8a0ef1fc4ee1b5db0bf88e16',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1383033110943977473,'http://localhost:9000/yeju/3854afad-cc2d-4514-ab6e-53abf234f8fc55af288e89d92.jpg',1,'fcd5b28bf8b58cb2888fb45cac530832',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1383036718498402306,'http://localhost:9000/yeju/fb8802f6-ad0e-4493-bbbc-ab0cb75ee448微信图片_20201218085912.jpg',1,'5d78fe0e59a2a679f96accb3a0c6ac98',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1383065734781501442,'http://localhost:9000/yeju/ae789212-5b81-40c7-b52d-2bfdab17451f8517583.jpg',1,'57941bb814dff4dd6500be982b8e8bb4',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(1383070757095636994,'http://localhost:9000/yeju/e9e498e0-0a25-473b-a961-15a20fa7314f8517805.jpg',1,'557a29922cc613c2c7c0f65b5a685f05',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `table_system_resources`(`resource_id`,`resource_name`,`resource_code`,`resource_type`,`parent_menu_id`,`order_number`,`path`,`componet_path`,`is_cache`,`resource_status`,`visible`,`icon`,`create_time`,`create_by`,`update_time`,`changed_by`,`remark`,`version_number`,`is_delete`,`is_frame`) values (1,'超级权限','*:**','1',NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,0),(2,'运营中心','system','0',0,0,'/system','Layout',1,1,1,'system',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(3,'监控中心','monitor','0',0,4,'/monitor','Layout',1,1,1,'monitor',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(4,'系统工具','tool','0',0,6,'/tool','Layout',1,1,1,'tool',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(5,'产商品中心','product','0',0,1,'/product','Layout',1,1,1,'product',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(6,'日志中心','log','0',0,5,'/log','Layout',1,1,1,'log',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(7,'客户中心','customer','0',0,2,'/customer','Layout',1,1,1,'user','2021-03-23 22:55:43',NULL,NULL,NULL,NULL,NULL,0,0),(8,'广告管理','advertise','0',0,3,'/advertise','Layout',1,1,1,'product','2021-04-15 19:04:42',NULL,NULL,NULL,NULL,0,0,0),(9,'交易中心','trade','0',0,1,'/trade','Layout',1,1,1,'trade','2021-04-21 21:38:39',NULL,NULL,NULL,NULL,NULL,0,0),(201,'员工管理','system:user:list','3',2,1,'user','system/user/index',1,1,1,'user',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(202,'角色管理','system:role:list','3',2,2,'role','system/role/index',1,1,1,'peoples',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(203,'菜单管理','system:menu:list','3',2,3,'menu','system/menu/index',1,1,1,'tree-table',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(204,'部门管理','system:dept:list','3',2,4,'dept','system/dept/index',1,1,1,'tree',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(205,'数据字典','system:dict:list','3',2,5,'dict','system/dict/index',1,1,1,'dict',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(206,'通知公告','system:notice:list','3',2,6,'notice','system/notice/index',1,1,1,'message',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(304,'在线用户','monitor:online:list','3',3,2,'online','monitor/online/index',1,1,1,'online','2021-02-20 16:09:46',NULL,NULL,NULL,NULL,NULL,0,0),(305,'定时任务','monitor:job:list','3',3,3,'job','monitor/job/index',1,1,1,'job','2021-02-21 10:43:24',NULL,NULL,NULL,NULL,NULL,0,0),(401,'api文档','tool:api','3',4,1,'swagger','tool/swagger/index',1,1,1,'monitor',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(402,'表单构建','tool:build','3',4,2,'build','tool/build/index',1,1,1,'tool',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(501,'房源审核','product:house:list','3',5,1,'house','product/house/index',1,1,1,'product',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(502,'地域管理','basedata:district:tree','3',5,2,'district','product/district/index',1,1,1,'tree-table','2021-04-18 15:24:32',NULL,NULL,NULL,NULL,NULL,0,0),(503,'社区管理','basedata:community','3',5,3,'community','product/community/index',1,1,1,'product','2021-04-20 21:23:59',NULL,NULL,NULL,NULL,NULL,0,0),(601,'登录日志','log:login:list','3',6,1,'logininfo','log/logininfo/index',1,1,1,'log',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(602,'操作日志','log:operation:list','3',6,2,'operlog','log/operlog/index',1,1,1,'log',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(603,'任务调度日志','log:job:list','3',6,3,'joblog','log/joblog/index',1,1,1,'log',NULL,NULL,NULL,NULL,NULL,NULL,0,0),(701,'客户管理','customer:list','3',7,0,'customer','customer/index',1,1,1,'user','2021-03-23 22:37:05',NULL,NULL,NULL,NULL,NULL,0,0),(702,'积分管理','integration:list','3',7,1,'integration','customer/integration/index',1,1,1,'product','2021-03-25 17:46:30',NULL,NULL,NULL,NULL,NULL,0,0),(801,'轮播图管理','advertise:banner:list','3',8,1,'banner','advertise/banner/index',1,1,1,'product','2021-04-15 19:08:25',NULL,NULL,NULL,NULL,0,0,0),(802,'短信模板管理','advertise:sms:list','3',8,2,'sms','advertise/sms/index',1,1,1,'product','2021-04-15 19:13:45',NULL,NULL,NULL,NULL,0,0,0),(901,'交易管理','trade:trade','3',9,0,'trade','trade/trade/index',1,1,1,'trade','2021-04-21 21:54:02',NULL,NULL,NULL,NULL,NULL,0,0),(902,'交易统计','trade:numerical','3',9,1,'numerical','trade/numerical/index',1,1,1,'numerical','2021-04-21 22:01:16',NULL,NULL,NULL,NULL,NULL,0,0);
